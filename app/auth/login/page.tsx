...
import { Heart, Eye, EyeOff, Mail, Lock, ArrowLeft, Loader2, Smartphone } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border border-gray-200 shadow-lg">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-gray-600">Sign in to your Medicare account</CardDescription>
          </CardHeader>
